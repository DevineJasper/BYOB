  ...
  .config([
    ...
    $routeProvider => {
      $routeProvider
        ...
        .when("/player/light", {
          templateUrl: "player/themes/light/index.html",
          controller: "Playerctrl"
        });
    }
  ])
  .controller("Playerctrl", [
    ...
    function($scope, $location) {
      ...
      fs.readFile("theme.txt", "utf-8", function(err, buf) {
        ...
        if (temp == "light") $location.path("/player/light");
        console.log(temp);
      });
          ...
          .read({
            onSuccess: function(tag) {
              ...
              if (image) {
                ...
                var base64 =
                  "data:image/jpeg;base64," + window.btoa(base64String);
